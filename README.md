...
I've also built a couple of smaller projects for myself or others — a [zero-knowledge password and secure note manager](https://github.com/sheikhmshadid/MasterPass) with client-side AES-256-GCM encryption, and an [AI-assisted nutrition and fitness tracker](https://github.com/sheikhmshadid/aiNutritionTracker) that turns a plain-English meal description into calorie and macro estimates — along with a few smaller tools here and there.
